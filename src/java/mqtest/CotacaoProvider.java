...
public class CotacaoProvider {    
    ...
    public static void accessBroker (String url) throws InterruptedException { 
        ...
        try {
            ...
            System.err.println("O Context.PROVIDER_URLespecificado: " + url); System.err.println("\n Detalhes da exceção:");
            ne.printStackTrace();
            System.exit(-1);
        }
        ...
        try {
            System.out.println("Pesquisandoobjeto de filacom onome:"+MYQUEUE_LOOKUP_NAME);
            ...
            System.err.println("\nDetalhes da exceção:"); ne.printStackTrace();
            System.exit(-1);
        } 

        try {
            System.out.println("Criando conexão com o broker"); connection = cf.createConnection();
            System.out.println("Conexão com o broker foicriada."); 
        } catch (JMSException e) {
            System.err.println("Falhou a criação com o broker."); System.err.println("\nDetalhes da exceção:"); e.printStackTrace();
            System.exit(-1);
        }
        ...
        try {
            ...
            while (true) {
                ...
                valor = valor + sorteiaNumero(); Thread.sleep(5000);
            }
        } catch (JMSException e) { 
