 ...
 */
public class HomeBrokerSwing extends JPanel { 
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new HomeBrokerSwing()); frame.setSize(300, 150);
    ...
    public static void accessBroker (String url) { 
        ...
        props.setProperty("java.naming.factory.initial","com.sun.enterprise.naming.Seri alInitContextFactory");
        props.setProperty("java.naming.factory.state","com.sun.corba.ee.impl.presentati on.rmi.JNDIStateFactoryImpl");
        ...
        try {
            ...
            System.err.println("FalhaaocriarInitialContext."); System.err.println("O Context.PROVIDER_URLespecificado: " + url); 
            System.err.println("\nDetalhes da exceção:");
            ne.printStackTrace();
            System.exit(-1); 
        }
